...
const Testimonial = () => {
  return (
    <>
      <h1 className="text-center text-[25px] mt-[25px]">Testimonials</h1>
      <div>
            ...
            <div className="md:flex md:flex-wrap md:-mx-4 mb-4">
                ...
                <div className="testimonial p-6 border-2 border-solid flex hover:border-indigo-400 hover:bg-indigo-100 transition-colors duration-300">
                  ...
                  <div>
                    <p className="text-gray-600">
                      "It really saves me time and effort. FWR Bootstrap Blocks
                      is exactly what our business has been lacking. FWR
                      Bootstrap Blocks was worth a fortune to my company. FWR
                      Bootstrap Blocks has really helped our business. I'm good
                      to go."
                    </p>
                ...
                <div className="testimonial p-6 border-2 border-solid flex hover:border-indigo-400 hover:bg-indigo-100 transition-colors duration-300">
                  ...
                  <div>
                    <p className="text-gray-600">
                      ...
                      upstanding and is behind its product 100%. Thanks guys,
              ...
              <div className="md:w-1/2 md:px-4 mt-6">
                <div className="testimonial p-6 border-2 border-solid flex hover:border-indigo-400 hover:bg-indigo-100 transition-colors duration-300">
                  ...
                  <div>
                    <p className="text-gray-600">
                      "FWR Bootstrap Blocks is exactly what our business has
                      been lacking. FWR Bootstrap Blocks is both attractive and
                      highly adaptable. Man, this thing is getting better and
                      better as I learn more about it."
                    </p>
                    <div className="text-gray-900 font-bold uppercase mt-6">
                      - Candace H.
                    </div>
                    <div className="text-gray-600">UP , India</div>
                  </div>
                </div>
              </div>
              ...
              <div className="md:w-1/2 md:px-4 mt-6">
                <div className="testimonial p-6 border-2 border-solid flex hover:border-indigo-400 hover:bg-indigo-100 transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Jammu Kashmir, India</div>
                  </div>
                </div>
              </div>
            </div>
